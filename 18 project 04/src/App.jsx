    ...
    <>
      <main className="relative">
        <div className="images">
          <img id="tomorrowland" src="/images/tommorowland.png" alt="" />
        ...
        <section id="section-1" className="relative">
          ...
          <nav className="flex justify-between items-center px-12 py-14">
            ...
            <div className="nav-elem mr-96 text-lg text-white font-semibold">
              <i className="ri-arrow-right-s-line text-red-500 font-bold"></i>{" "}
              &nbsp; Our Showreel
            </div>
            <div className="nav-elem">
              <i className="ri-menu-3-fill text-3xl text-white"></i>
            </div>
          </nav>
          <div className="middle flex gap-5 mt-20">
            {/* we are avoiding to give width so instead we use grow */}
            <div className="left w-1/2 flex items-center justify-end">
              <h1 className="text-right font-gt text-9xl leading-[0.8] text-white">
                We <br /> Make <br /> Good <br /> Shit <br />
              </h1>
            </div>
            <div className="right w-1/2"></div>
          </div>
          <div className="bottom flex gap-30">
            <div className="left w-1/2 "></div>
            <div className="right w-1/2 ">
              <p className="font-light leading-[1.7] text-2xl text-white">
          ...
          <div className="first-line w-[35rem] bg-[rgba(255,0,0,0.76)] h-px rotate-45 absolute translate-x-[1vw] -translate-y-52"></div>
          <div className="second-line w-[10rem] bg-[rgba(255,0,0,0.76)] h-px -rotate-45 absolute translate-x-[70vw] -translate-y-120"></div>
        </section>
        <section id="section-2" className="py-40">
          <div className="titles flex flex-col px-60">
            <small className="text-[1rem] font-gt opacity-50 uppercase ml-30 mb-5">
              Future Projects
            </small>
            <div
              img-title="tomorrowland"
              className="title flex gap-16 opacity-30 py-8"
            >
              <small className="mt-[0.1rem] text-[0.5rem]">
                2020 - ONGOING
              </small>
              <h1 className="text-[4.5rem] font-Heebo-thin leading-none">
                Tomorrowland
              </h1>
            </div>
            <div
              ...
              className="title flex gap-16 opacity-30 py-8"
            >
              <small className="mt-[0.1rem] text-[0.5rem]">2018 - TODAY</small>
              <h1 className="text-[4.5rem] font-Heebo-thin leading-none">
                Navy Pier
              </h1>
            </div>
            <div
              ...
              className="title flex gap-16 opacity-30 py-8"
            >
              <small className="mt-[0.1rem] text-[0.5rem]">2015 - TODAY</small>
              <h1 className="text-[4.5rem] font-Heebo-thin leading-none">
                MSI Chicago
              </h1>
            </div>
            <div
              ...
              className="title flex gap-16 opacity-30 py-8"
            >
              <small className="mt-[0.1rem] text-[0.5rem]">2016</small>
              <h1 className="text-[4.5rem] font-Heebo-thin leading-none">
                This Was Louise's Phone
              </h1>
            </div>
            <div img-title="kikk" className="title flex gap-16 opacity-30 py-8">
              <small className="mt-[0.1rem] text-[0.5rem]">2012 - TODAY</small>
              <h1 className="text-[4.5rem] font-Heebo-thin leading-none">
                KIKK Festival 2018
              </h1>
            </div>
            <div
              ...
              className="title flex gap-16 opacity-30 py-8"
            >
              <small className="mt-[0.1rem] text-[0.5rem]">2017</small>
              <h1 className="text-[4.5rem] font-Heebo-thin leading-none">
                The Kennedy Center
              </h1>
            </div>
