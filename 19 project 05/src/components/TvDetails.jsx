...
const TvDetails = () => {
  document.title = "YoYo Movies | Series ";
  ...
  return info ? (
    <div
      ...
      className="w-screen h-[202vh] p-10 overflow-y-hidden relative"
    >
      {/* part 1 navigation */}
      ...
      <div className="w-full flex ml-10 mt-10">
        ...
        <div className="content ">
          ...
          <div className="flex">
            <span className="absolute left-[16%] top-[10.7%] rounded-full text-lg font-semibold bg-yellow-500 w-[7vh] h-[7vh] justify-center items-center text-center pt-3">
      ...
      {/* part 4 Seasons */}
      <div>
        <h1 className="text-2xl font-semibold mt-5">Seasons</h1>
        <HorizontalCards
          h={`50vh`}
          h2={`60vh`}
          data={
